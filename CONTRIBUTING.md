...
We welcome all contributions to Evaluator Equilibration!

Contributions can take many forms, such as:

* sharing bug reports or feature requests through the [Issue Tracker](https://github.com/lilyminium/evaluator-equilibration/issues)
...
The second two options both involve making a [pull request](https://github.com/lilyminium/evaluator-equilibration/pulls) .
